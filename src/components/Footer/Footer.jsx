...
const Footer = () => {
  return (
    <>
      <footer className='w-full bg-navbarcolor'>
        <div className='container mx-auto px-0 pt-[75px]'>
          <div className='grid grid-cols-1 lg:grid-cols-12 gap-4'>
            <div className='col-span-4'>
              <Typography className='text-3xl text-white font-bold pb-3'>
                Matahari Concept
              </Typography>
            ...
            <div className='our-products col-span-4 flex justify-start lg:justify-center'>
              <div className='text-white'>
                <h2 className='font-semibold divide-x- text-3xl pb-3'>
                  Our Products
                </h2>
                <hr className='border-t-4 border-black w-[80px]'></hr>
            ...
            <div className='maps col-span-4 flex justify-start lg:justify-center'>
              <div className='text-white'>
                <h2 className='font-semibold divide-x-2 text-3xl pb-3 '>
                  Reach Us
                </h2>
                <hr className='border-t-4 border-black w-[80px]'></hr>
